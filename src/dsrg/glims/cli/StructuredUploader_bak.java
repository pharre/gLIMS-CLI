...
public class StructuredUploader_bak {
	...
	public static void main(String[] args) {
		Preconditions.checkArgument(args.length >= 3,
				"Usage: java -jar StructuredUploader.jar <path to file> <path to gdrive> <root name> <transpose?>");
		...
		transpose = false;
		gDir = "C:\\Users\\pharre\\Google Drive\\";
...
//				drive.permissions().insert(uploadedFile.getId(), perm).execute();
	...
	private static void writeDocsLabelsFromBlobStandardFormatNoBatch(String fileName, String rootName, Drive service)
		...
		StructuredUploader_bak uploader = new StructuredUploader_bak();
